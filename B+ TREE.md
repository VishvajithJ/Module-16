...
## OUTPUT
![image](https://github.com/user-attachments/assets/18115ee8-c8dd-4aee-b575-fd52eb15d5e4)

## RESULT
The Python program for inserting nodes into a B+ Tree was successfully implemented. The insertions and node splits worked correctly, and the tree structure was displayed using the show() method.
